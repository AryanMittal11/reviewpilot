...
export default function SubscriptionPage() {
    ...
    if (!data?.user) {
        return (
            <div className="space-y-6">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Subscription Plans</h1>
                    <p className="text-muted-foreground">Please sign in to view subscriptions options</p>
                </div>
            </div>
        )
    }
    ...
    return (
        <div className="space-y-6">
            ...
            {success === "true" && (
                <Alert className="border-green-500 bg-green-50 dark:bg-gray-950">
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    {isPro ? "No limits on reviews" : "Free tier allow 5 reviews per repository"}
                                </p>
                            </div>
                        </div>
                    </CardContent>
                    ...
                    <CardHeader>
                        <div className="flex items-start justify-between">
                            <div>
                                ...
                                <CardDescription>For professionals developers</CardDescription>
                            </div>
                            {isPro && <Badge className="ml-2">Current Plan</Badge>}
                        </div>
                        <div className="mt-2">
