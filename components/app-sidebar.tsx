                            ...
                            <SidebarMenuItem key={item.title}>
                                <SidebarMenuButton
                                    ...
                                    className={`h-11 px-4 rounded-lg transition-all duration-200 ${isActive(item.url) ? 
                                        "bg-sidebar-accent text-sidebar-accent-foreground font-semibold" : "hover:bg-sidebar-accent/60 text-sidebar-foreground"
                                    }`}
                                >
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                ...
                                >
                                    ...
                                    <div className='grid flex-1 text-left text-sm loading-relaxed min-w-0'>
